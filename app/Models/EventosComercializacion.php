...
class EventoComercializacion extends Model
{
  ...
  protected $fillable = [
    'flota_virtual_id','contraparte_id','contrato_id',
    'tipo_evento','tipo_registro','producto_clave',
    'fecha_hora_inicio','fecha_hora_fin',
    'temperatura','presion_absoluta',
    'volumen_inicial_valor','volumen_inicial_um',
    'volumen_movido_valor','volumen_movido_um',
    'volumen_final_tanque',
    'existencias','complemento','observaciones',
  ];
